...
export const TRAINED_BRAIN = {
  ...
  spotFx: 2.7, // shooting spot distance from its ALLIANCE WALL for a chassis-aimed shooter (turrets shoot from anywhere in the zone) (m)
  spotZ: 0.9, // minimum sideways offset of the chassis-aimed shooting spot from the HUB (m)
  shootSpeed: 0.45, // top speed while shooting or passing on the move, so the turret/flywheel can settle (fraction of top speed)
  shootAccel: 3, // how quickly it changes velocity while shooting or passing (m/s²)
  pushThrough: 1.5, // s of being blocked on the way to its zone before it stops going around and drives through
  shuttle: 1, // during an inactive shift, collect in the NEUTRAL ZONE and pass everything into its ALLIANCE ZONE, then load up just before its HUB turns on (on at 50% or more)
  passBatch: 10, // a chassis-aimed shooter passes once it holds this many FUEL (turrets pass while they collect)
  dropFx: 2.6, // distance from its ALLIANCE WALL where its passes land (m)
  ...
  steal: 2, // extra preference for FUEL in the opponent's ALLIANCE ZONE: taking it both denies them and feeds us (m)
