...
- 4414's model follows its tech binder CAD renders (`binder_assets/CadPhotos/*.webp` on 2026.team4414.com; its CAD isn't public): a box intake on racks, the Dye Rotor (a rotating floor, a center column under the turret, the Dolphin Fin, a spiral roller ramp), and smoked walls with the teal truss frame. 2910's intake is their own CAD part (`cad/robots/2910-intake.glb`, made with `tools/extract-part.mjs`), and its reach comes from that CAD. The hopper extensions really extend, intake arms reach the rated reach, polycarbonate is tinted, and the HUB lights sit on the real diffusers (`HUB.lightY0/1`).
