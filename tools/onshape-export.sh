...
# Defaults to the official field, "FE-2026: REBUILT Playing Field" (set DID and WID for another
# document, e.g. 2910's robot). Other elements in the field document:
...
DID=${DID:-8a691e28680da30504859fce}
WID=${WID:-c6aa636fb23edb3f1e272fb1}
